...
class UIController:
    def __init__(self, master: Tk, history_list: Tk, width, height):
        ...
        self.im_label2 = Mymethod.GetImage("F:\\幻书启世录\\物料资源\\幻书立绘\\幻书立绘\\初音立绘.png", 200, 300)
        ...
        self.left_image = ttk.Label(self.master, image=self.im_label2)  # 左边的人物图片
        self.combobox_leftimage = ttk.Combobox(master=self.master, font=("微软雅黑", 12), state='readonly',
        ...
        self.button_test = ttk.Button(self.master, text="TestButton", command=self.Click_Test)  # 功能测试按钮
        ...
        self.left_image.place(x=100, y=100, width=220, height=340)  # 左边的人物图片
        self.combobox_leftimage.place(x=100, y=80, width=80, height=20)  # 这句话的类型
        self.mid_image.place(x=365, y=100, width=220, height=340)  # 中间的人物图片
        self.right_image.place(x=630, y=100, width=220, height=340)  # 右边的人物图片
